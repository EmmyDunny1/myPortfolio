...
<button className='relative h-[3rem] w-[8rem] border-solid border-pink-400 border-2 text-pink-400 text-xl font-bold rounded-xl z-10'>Let's Talk</button>

<button className=' absolute h-[3rem] w-[8rem] bg-pink-400  text-pink-400 text-xl font-bold rounded-xl mb-10 ml-[-8rem] z-5'>Let's Talk</button>
