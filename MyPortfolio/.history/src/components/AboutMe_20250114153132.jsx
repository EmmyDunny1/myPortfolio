...
<br />
        ...
        <div className=' group relative'><img src={myImage} alt="my picture" className='object-cover h-[20rem] w-[20rem] items-center  hover:translate-y-2 transition-transform ' />
