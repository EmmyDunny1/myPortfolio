  ...
  return (
    ...
    <div className=" flex items-center justify-between py-4 mx-[4rem]">
      ...
      <div className="flex items-center space-x-8 ">
        <a
          href="#about"
          className="hover:text-green text-sm font-mono border-l-2 border-solid rounded-md px-2 ">
           About
        </a>
        <a
          href="#experience"
        ...
        <a
          href="#contact"
          className="hover:text-green text-sm font-mono border-l-2 border-solid border-pin rounded-md px-2">
           Contact
        </a>
        <a
          href="/resume.pdf"
