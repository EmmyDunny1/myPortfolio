...
<br />
        ...
        <div className='relative'><img src={myImage} alt="my picture" className='object-cover h-[20rem] w-[20rem] items-center  hover:translate-y-2 transition-transform z-10 ' />
        <div className='absolute inset-0 bg-pink-500 opacity-50  z-5'></div>
        </div>
