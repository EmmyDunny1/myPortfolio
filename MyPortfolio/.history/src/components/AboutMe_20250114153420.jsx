...
<br />
        ...
        <div className='  relative hover:translate-y-2 transition '><img src={myImage} alt="my picture" className='object-cover h-[20rem] w-[20rem] items-center   transition-transform ' />
