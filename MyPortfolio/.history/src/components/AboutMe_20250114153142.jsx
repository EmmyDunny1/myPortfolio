...
<br />
        ...
        <div className=' group relative hover:translate-y-2'><img src={myImage} alt="my picture" className='object-cover h-[20rem] w-[20rem] items-center   transition-transform ' />
        <div className='absolute inset-0 bg-pink-500 opacity-50 pointer-events-none group-hover:translate-y-2'></div>
        </div>
