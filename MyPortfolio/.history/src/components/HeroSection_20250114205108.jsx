...
<button className='h-[3rem] w-[8rem] border-solid border-pink-400 border-2 text-pink-400 text-xl font-bold rounded-xl'>Let's Talk</button>

<button className='h-[3rem] w-[8rem] border-solid border-pink-400 border-2 text-pink-400 text-xl font-bold rounded-xl pb-5 ml-[-200px]'>Let's Talk</button>
