...
<br />
        ...
        <div className='  relative hover:translate-y-2 border-solid pr-4 pb-4 rounded-md border-pink-700 border-r-4 border-b-4 hover:translate-x-2 transition duration-300'>
