...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex'> 
    <nav className= { `${!mobileDrawerOpen ? "md:block": "hidden" } fixed top-0 left-0 w-full bg-dark-navy shadow-sm  shadow-black text-gray-300 z-10`}>
    <div className=" flex items-center justify-between py-4 mx-[4rem]">
      ...
      <FiMenu className='lg:hidden flex h-6 w-6 cursor-pointer' onClick={() => setMobileDrawerOpen(!mobileDrawerOpen)}/>
