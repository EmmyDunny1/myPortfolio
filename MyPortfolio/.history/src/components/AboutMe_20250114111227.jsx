...
const AboutMe = () => {
  return (
    ...
    <div className='flex'>
        <div>
            <p className='text-gray-400 text-xl'>I'm Oluwadunsin Akinbo, a software developer <br />currently spacialized in frontend development, who has a keen eye for detail with a high taste <br />for captivating designs driven with strong passion for crafting user-friendly websites <br />for lead generation and business growth.
