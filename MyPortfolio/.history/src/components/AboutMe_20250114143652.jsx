  ...
  return (
    ...
    <div className='flex'>
        <div className=''>
            ...
            <br />
<br className='pb-0' />
               <span className='pt-8'>My Interest in web development began with key interest in graphic <br />designs few years ago and then later UI/UX designs for responsive <br />user-friendly designs.  </span>
