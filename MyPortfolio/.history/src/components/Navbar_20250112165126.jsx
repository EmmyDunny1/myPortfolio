    ...
    <div className=" flex items-center justify-between py-4 mx-[4rem]">
      ...
      <div className="flex items-center space-x-8 ">
        ...
        <a
          href="/resume.pdf"
          download
          className="border border-green text-pink-400 px-4 py-2 rounded text-sm font-mono hover:bg-green hover:text-dark-navy hover:shadow-sm hover:shadow-gray-300 hover:border-gray-300 hover:text-gray-300 transition border-pink-400">
          Resume
        </a>
      </div>
    </div>
