...
const AboutMe = () => {
  return (
    ...
    <div className='flex'>
        <div>
            <p className='text-gray-400'>I'm Oluwadunsin Akinbo, a software developer currently spacialized in frontend development, who has a keen eye for detail with a high taste for captivating designs driven with strong passion for crafting user-friendly websites for lead generation and business growth.
