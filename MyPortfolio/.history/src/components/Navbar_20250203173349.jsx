    ...
    <div className='relative'>
      <nav className='fixed top-0 left-0 w-full bg-dark-navy shadow-sm shadow-black text-gray-300 z-10'>
        <div className="flex items-center justify-between py-4 mx-[4rem]">
          ...
          <FiMenu className='lg:hidden flex h-6 w-6 cursor-pointer' onClick={toggleMobileDrawer} />
      ...
      <div className={`${mobileDrawerOpen ? 'block' : 'hidden'} fixed top-0 left-0 w-3/4 h-full bg-dark-navy shadow-lg z-30`}>
        <div className="flex items-center justify-between p-4">
          <img src={WEBCANIC} className='h-[4rem] w-[4rem] object-cover' alt="" />
          <FiX className='h-6 w-[20rem] cursor-pointer' onClick={toggleMobileDrawer} />
        </div>
        <div className="flex flex-col items-start space-y-4 p-4">
          <a href="#about" className="block w-full">About</a>
          <a href="#experience" className="block w-full">Experience</a>
          <a href="#work" className="block w-full">Work</a>
          <a href="#tech-stack" className="block w-full">Tech Stack</a>
          <a href="#contact" className="block w-full">Contact</a>
          <a href="/resume.pdf" download className="block w-full">Resume</a>
        </div>
      </div>
    </div>
  );
