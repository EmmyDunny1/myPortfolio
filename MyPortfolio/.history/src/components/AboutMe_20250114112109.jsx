    ...
    <div className='flex'>
        <div className=''>
            ...
            <br />
               ...
               <span>My Interest in web development began with key interest in graphic designs few years ago and then later UI/UX designs for responsive user-friendly designs.  </span>
