...
const AboutMe = () => {
  return (
    ...
    <div className='flex'>
        <div className=''>
            <p className='text-gray-400 text-xl'>I'm Oluwadunsin Akinbo, a software developer currently spacialized <br />in <span className='text-pink-'>frontend development </span>
