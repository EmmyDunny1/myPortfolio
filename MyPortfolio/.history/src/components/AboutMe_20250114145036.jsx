    ...
    <div className='flex'>
        <div className=''>
            ...
            <br />
               ...
               <span className='pt-10 text-pink'>My Interest in web development began with key interest in graphic <br />designs few years ago and then later UI/UX designs for responsive <br />user-friendly designs.  </span>
