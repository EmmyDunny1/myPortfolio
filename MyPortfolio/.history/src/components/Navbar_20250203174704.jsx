    ...
    <div className='relative'>
      <nav className='fixed top-0 left-0 w-full bg-dark-navy shadow-sm shadow-black text-gray-300 z-10'>
        <div className="flex items-center justify-between py-4 mx-[4rem]">
          ...
          <FiMenu className='md:hidden flex h-6 w-6 cursor-pointer' onClick={toggleMobileDrawer} />
      ...
      <div className={`${mobileDrawerOpen ?  'md:block' : 'hidden'} fixed ml-[7.3%] top-0 left-0 w-3/4 h-full bg-dark-navy shadow-lg z-30`}>
