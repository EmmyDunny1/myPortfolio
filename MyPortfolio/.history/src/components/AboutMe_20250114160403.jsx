...
<br />
        ...
        <div className='  relative hover:translate-y-2 hover:translate-x-2 transition duration-300'><img src={myImage} alt="my picture" className='object-cover h-[20rem] w-[20rem] items-center   transition-transform ' />
        <div className='absolute inset-0 bg-pink-500 opacity-50 '>
         </div>

         <div className=' absolute top-[2rem] left-[2rem] h-[20rem] w-[20rem] border-solid border-pink-500'></div>
        </div>
