...
const AboutMe = () => {
  return (
    ...
    <div className='flex'>
        <div className=''>
            <p className='text-gray-400 text-xl leading-normal justify-center text-'>I'm Oluwadunsin Akinbo, a software developer currently spacialized <br />in <span className='text-pink-400'>frontend development </span>
