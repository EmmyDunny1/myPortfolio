...
<button className='h-[3rem] w-[8rem] border-solid border-pink-400 border-2 text-pink-400 text-xl font-bold rounded-xl z-1'>Let's Talk</button>

<button className='h-[3rem] w-[8rem] border-solid bg-pink-400 border-2 text-pink-400 text-xl font-bold rounded-xl pb-5 ml-[-30px] z-0'>Let's Talk</button>
